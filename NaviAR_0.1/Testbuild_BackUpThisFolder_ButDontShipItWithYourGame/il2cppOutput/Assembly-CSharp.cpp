...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MapScriptTest_Start_mB2D11B4731F2988F986F67DF1CDA939CFE1DA18D (MapScriptTest_t8DD8D64C2C077165B7CB806836063B1779B51E7A* __this, const RuntimeMethod* method) 
{
	...
	memset((&V_0), 0, sizeof(V_0));
	{
		...
		// mapCoroutine = GetGoogleMap(lat, lon);
		float L_1 = __this->___lat_5;
		float L_2 = __this->___lon_6;
		RuntimeObject* L_3;
		L_3 = MapScriptTest_GetGoogleMap_mBC77C1AD7E65BBFCE8310C55827AFF15AF0363EB(__this, L_1, L_2, NULL);
		__this->___mapCoroutine_14 = L_3;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___mapCoroutine_14), (void*)L_3);
		// StartCoroutine(mapCoroutine);
		RuntimeObject* L_4 = __this->___mapCoroutine_14;
		...
		V_0 = L_7;
		float L_8;
		L_8 = LocationInfo_get_latitude_mAF0A46443555AF18EA3C516292CB92B1669CA863((&V_0), NULL);
		__this->___lat_5 = L_8;
		...
		V_0 = L_10;
		float L_11;
		L_11 = LocationInfo_get_longitude_mCB720DD0E139B7C614F78D40595E1BBF1F5433A2((&V_0), NULL);
		__this->___lon_6 = L_11;
		// }
		return;
	}
}
